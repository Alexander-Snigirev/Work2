/*5.6.2. В каких случаях (при каких политиках) установка разных приоритетов повлияет на 
очередность исполнения потоков одного процесса. 
Сравните с результатами по независимым потокам.*/
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
