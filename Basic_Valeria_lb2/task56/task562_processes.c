/*5.6.1. Приведите эксперименты с изменением политики 
для всех потоков одного процесса при условии их равных приоритетов. 
Измените политику только для одного или нескольких 
потоков из множества всех равноприоритетных потоков одного процесса.*/
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
