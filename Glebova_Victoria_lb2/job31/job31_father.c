/*3.1. С помощью команды kill -l ознакомьтесь с перечнем сигналов, 
поддерживаемых процессами, а также с системными вызовами kill(2), signal(2).
 Создайте программу, демонстрирующую все возможные реакции процесса* (или процессов) на поступление сигнала.*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
#include <sys/types.h>
