/*5.1. Определите политику планирования и приоритет, установленные по умолчанию, для процессов и потоков, 
запускаемых пользователем из shell (сначала из таблицы процессов, а затем программно).
Проанализируйте очередность исполнения процессов, проведя соответствующий эксперимент*/
#define _GNU_SOURCE
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
